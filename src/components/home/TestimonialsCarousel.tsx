...
export function TestimonialsCarousel() {
  ...
  return (
    <section ref={ref} className="py-20 sm:py-28 bg-gradient-to-b from-neutral-50 to-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <motion.button
              onClick={() => paginate(-1)}
              className="w-12 h-12 rounded-full bg-white shadow-lg hover:shadow-xl border border-neutral-200 flex items-center justify-center text-neutral-700 hover:text-primary-600 transition-all"

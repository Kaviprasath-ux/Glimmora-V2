...
import { Check, ArrowLeft, Star, Sparkles, Eye, TrendingUp, Bed, Sun, Moon, Trees, Volume2 } from 'lucide-react';
...
const mockRooms = [
  {
    ...
    features: ['Corner unit', 'Balcony', 'Sunset views'],
  },
  {
    id: '1108',
    ...
    features: ['Near amenities', 'Ocean breeze'],
  },
  {
    id: '0815',
    name: 'City View Room',
    ...
    features: ['Value option', 'City lights'],
  },
];
...
export function AIRoomSelectionStep({ onNext, onPrevious }: AIRoomSelectionStepProps) {
  ...
  const { updatePreCheckInData } = usePreCheckIn();
  ...
  const handleRoomSelect = (roomId: string) => {
    ...
    updatePreCheckInData({ selectedRoom: newSelection });
  };
                ...
                {selectionMode === 'ai' && (
                  <div className="flex items-center gap-2 mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <span className="text-sm font-medium text-green-900">
                      Found {mockRooms.length} perfect matches
                    </span>
                  </div>
                )}
                ...
                {mockRooms.map((room) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {selectionMode === 'ai' && room.aiScore >= 95 && (
                              <span className="px-2 py-0.5 bg-[#A57865] text-white text-xs font-medium rounded">
                                Best Match
                              </span>
                            )}
                      ...
                      {selectionMode === 'ai' && (
                        <div className="mb-3">
                          ...
                          <ul className="space-y-1">
                            {room.aiReasoning.map((reason, idx) => (
                      ...
                      {/* Features - Only show in manual mode */}
                      ...
                      {/* Price */}
                      <div className="text-sm font-semibold text-neutral-900 pt-3 border-t border-neutral-200">
                        ${room.price}/night
                      </div>
                    </button>
                  );

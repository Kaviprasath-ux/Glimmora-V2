      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <div className="text-center">
            ...
            >
              Welcome to Glimmora, {preCheckInData.personalInfo.email?.split('@')[0] || 'Guest'}! Your room is ready and waiting.
            </motion.p>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Room {preCheckInData.selectedRoom || 'TBA'}</p>
                </div>
              </div>
            ...
            {/* Download Button */}
            <button className="w-full py-3 bg-white text-[#A57865] font-semibold rounded-2xl hover:bg-neutral-50 transition-all flex items-center justify-center gap-2">

          ...
          <div className="grid grid-cols-4 grid-rows-2 gap-3 h-[500px] sm:h-[600px]">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-bold text-neutral-900">View All {room.images.length} Photos</span>
              </motion.button>
            </motion.div>
                ...
                >
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-3 mb-2">
                      ...
                      <span className="text-4xl font-bold text-white">+{room.images.length - 4}</span>
                    </div>
